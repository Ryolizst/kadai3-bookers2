  ...
  describe '他人の画面のテスト' do
    ...
    describe '他人の投稿詳細画面のテスト' do
      ...
      context '表示内容の確認' do
        ...
        it '投稿のopinionが表示される', spec_category: "CRUD機能に対するコントローラの処理と流れ(ログイン状況を意識した応用)" do
          expect(page).to have_content other_book.body
        end
      ...
      context 'サイドバーの確認' do
        ...
        it '他人のユーザ編集画面へのリンクが存在しない' do
           visit user_path(other_user)
           expect(page).not_to have_link 'Edit User', href: edit_user_path(other_user)
        end
    ...
    describe '他人のユーザ詳細画面のテスト' do
      ...
      context '表示の確認' do
        ...
        it '投稿一覧に他人の投稿のopinionが表示される', spec_category: "基本的なアソシエーション概念と適切な変数設定" do
          expect(page).to have_content other_book.body
        end
